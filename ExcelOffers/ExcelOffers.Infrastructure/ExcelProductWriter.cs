    ...
    internal class ExcelProductWriter
    {
        public void NewSheetOffer(ExcelPackage package, List<Product> listFiltered)
        {
            ...
            try
            {
                ...
                newSheet.Cells[1, 8].Value = "Tarifa FIT por Hóspede (promocional)";
                newSheet.Cells[1, 9].Value = "Tarifa DE por hósp.";
                newSheet.Cells[1, 10].Value = "Tarifa promocional por hósp.";
                newSheet.Cells[1, 11].Value = "Desconto %";
                newSheet.Cells[1, 12].Value = "NCCF por hósp.";
                newSheet.Cells[1, 13].Value = "Tx. Porto por hósp.";
                newSheet.Cells[1, 14].Value = "Tx. Serviço por hósp.";
                newSheet.Cells[1, 15].Value = "Valor total por hósp.";
                newSheet.Cells[1, 16].Value = "Entrada B2B";
                newSheet.Cells[1, 17].Value = "Parcelamento B2B";
                newSheet.Cells[1, 18].Value = "Entrada B2C";
                ...
                foreach (var item in listFiltered)
                {
                    ...
                    cellValue.SetCellValue(newSheet, row, ref column, item.Fares.FareFitPerPax, "#,##0");
                    ...
                    cellValue.SetCellValue(newSheet, row, ref column, item.Fares.ServiceFarePerPax, "#,##0.00");
